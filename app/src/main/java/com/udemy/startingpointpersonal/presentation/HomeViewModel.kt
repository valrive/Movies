...
class HomeViewModel @Inject constructor(
    ...
    private val _logoutBtn = MutableLiveData<Result<Unit>>()
    val logoutBtn: LiveData<Result<Unit>> = _logoutBtn
    ...
    fun onLogoutClick() {
        _logoutBtn.value = Result.Loading
        // do logout
        homeDomain.logout()
        _logoutBtn.value = Result.Success(Unit)
    }
}